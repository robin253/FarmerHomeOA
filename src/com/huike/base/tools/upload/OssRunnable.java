...
//     *            上传到OSS后的文件名 
//     */  
//    public OssRunnable(MultipartFile localFile, long startPos, long partSize, int partNumber, String uploadId, String key , String bucketName) {  
...
//        OssRunnable.key = key;  
//        OssRunnable.bucketName = bucketName;  
//    }  
//  
//    /** 
...
//            UploadPartResult uploadPartResult = FileOssUtil.client.uploadPart(uploadPartRequest);  
...
//        InitiateMultipartUploadResult result = FileOssUtil.client.initiateMultipartUpload(request);  
...
//        // 完成分块上传  
//        FileOssUtil.client.completeMultipartUpload(completeMultipartUploadRequest);  
//    }  
//  
//    /** 
//     * 列出文件所有分块的清单 
...
//        // 获取上传的所有分块信息  
//        PartListing partListing = FileOssUtil.client.listParts(listPartsRequest);  
//  
//        // 获取分块的大小  
